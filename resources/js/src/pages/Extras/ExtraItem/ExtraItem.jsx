      ...
      <div className="extra-item-card">
        ...
        <div className="custom-card">
          <span className="extra-item-badge">
            {formatPrice(extra?.sale_price ? extra?.sale_price : extra?.price)}
            {" €"}
          </span>
          ...
          <div className="card-header position-relative">
            {extra?.thumbnail ? (
              <img
                ...
                src={
                  extra?.thumbnail
                    ? `https://events.essenciacompany.com/storage/${extra?.thumbnail}`
                    : "/images/no-image.jpg"
                }
          ...
          <div className="card-body extra-item-body">
            <p title={extra.display_name} className="extra-item-name">
