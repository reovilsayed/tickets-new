...
<head>
    ...
    <meta http-equiv="Content-Security-Policy"
        content="default-src 'self' 'unsafe-inline' 'unsafe-eval' https:; img-src 'self' data: https:; style-src 'self' 'unsafe-inline' https:; script-src 'self' 'unsafe-inline' 'unsafe-eval' https:;">
                ...
                if (widthThreshold || heightThreshold) {
                    if (!devtools.open) {
                        ...
                        document.body.innerHTML =
                            '<div style="display: flex; justify-content: center; align-items: center; height: 100vh; color: white; font-size: 24px;">⚠️ Developer Tools are not allowed on this page</div>';
                    }
                } else {
                    devtools.open = false;
                }
