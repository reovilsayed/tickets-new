...
use App\Voyager\Http\Controllers\Controller;
use Exception;
...
class VoyagerCustomerController extends Controller
{
    ...
    public function update(Request $request, $id)
    {
        ...
        if (session()->has('previous_url') && session('previous_url.url') != url()->previous()) {
            return redirect()->to(session('previous_url.url'))->with([
