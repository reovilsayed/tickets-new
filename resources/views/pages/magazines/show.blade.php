...
@section('content')
  <form action="{{ route('cart.store', $magazine->id) }}" method="post">
    @csrf
          ...
          <div x-data="eventData" x-effect="calculateTotal()" class="col-md-7 event-box" id="mobile-device">
            ...
            <ul class="nav nav-pills sec-hd mb-3 sticky-sm-top" id="pills-tab" role="tablist">
              <li class="nav-item" role="presentation">
                <button class="nav-link active" id="pills-profile-tab" data-bs-toggle="pill" data-bs-target="#pills-onetime-purchase" type="button" role="tab" aria-controls="pills-profile" aria-selected="false" onclick="resetProductsScroll(event)">
                  <div class="days">
                    One-time purchase
                    <span class="dot"></span>
                  </div>
              ...
              <li class="nav-item" role="presentation">
                <button class="nav-link" data-bs-toggle="pill" data-bs-target="#pills-annual-purchase" type="button" role="tab" aria-controls="pills-profile" aria-selected="false" onclick="resetProductsScroll(event)">
                  <div class="days">
                    Annual Subscription
                    <span class="dot"></span>
                  </div>
              ...
              <li class="nav-item" role="presentation">
                <button class="nav-link" data-bs-toggle="pill" data-bs-target="#pills-bi-annual-purchase" type="button" role="tab" aria-controls="pills-profile" aria-selected="false" onclick="resetProductsScroll(event)">
                  <div class="days">
            ...
            <div class="tab-content" id="pills-tabContent">
              <div class="tab-pane fade show active" id="pills-onetime-purchase" role="tabpanel" aria-labelledby="pills-home-tab">
              ...
              <div class="tab-pane fade" id="pills-annual-purchase" role="tabpanel" aria-labelledby="pills-home-tab">
              ...
              <div class="tab-pane fade" id="pills-bi-annual-purchase" role="tabpanel" aria-labelledby="pills-home-tab">
                <div class="card card-ticket">
                  <div class="card-body tick">
                    <div class="ticket-info">
                      <div class="t-info">
