                ...
                <tr>
                  ...
                  <td style="display: none">
                    @if ($allOrder->alert == 'unmarked')
                      <button type="button" class="btn btn-primary ticket-marked-button" data-url="{{ route('order.marked', $allOrder) }}" data-bs-toggle="modal" data-bs-target="#ticket-marked">
                        Mark
                      </button>
                    ...
                    @endif
                    <span class="d-none" id="ticket-action-url-{{ $allOrder->id }}" data-email-url="{{ route('order.email', $allOrder) }}" data-sms-url="{{ route('order.sms', $allOrder) }}"></span>
                    <button type="button" class="btn btn-primary ticket-action-button" data-order-no="{{ $allOrder->id }}" data-has-product="{{ $allOrder->tickets_count === 0 ? 0 : 1 }}" data-url="{{ route('order.update', $allOrder) }}" data-email="{{ $allOrder->billing->email ?? $allOrder->user->email }}" data-phone="{{ $allOrder->billing->phone ?? $allOrder->user->contact_number }}" data-bs-toggle="modal"
