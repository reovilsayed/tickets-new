                        ...
                        @if (Cart::getTotalQuantity() > 0)
                            <div class="ec-cart-content">
                                <div class="ec-cart-inner">
                                    <h4 class="p-1 cart-heading text-cus-secondary h2">{{ Cart::getTotalQuantity() }} Ticket</h4>
                                    @if (Cart::getTotalQuantity() > 0)
                                        <div class="row">
                                            @foreach ($items as $item)
                                                <div class="cart-item card rounded-4 mb-4">
                                                    <div class="card-body row box-shadow">
                                                            ...
                                                            <form action="{{ route('cart.update') }}" method="POST">
                                                                ...
                                                                <div class="form-group  col-md-12 d-flex">
                                                                    ...
                                                                    <button type="submit" class="btn border btn-dark "
                                                                        ...
                                                                        id="basic-addon2"><span>Update</span></button>
                                                        ...
                                                        <div class="col-md-3 justify-content-center align-item-center mt-3">
                                                            <h1 class="cart-text">
                            ...
                            <div class="ec-sb-block-content">
                                <div class="ec-cart-summary-bottom">
                                    <div class="ec-cart-summary p-4">
                                        ...
                                        <div>
                                            <span class="text-left">Total ({{ Cart::getTotalQuantity() }} Ticket)</span>
                                        ...
                                        <a href="{{ route('checkout') }}" class="butn-dark2 mt-3"><span>Apply to
                                                Process</span></a>
                                    </div>
