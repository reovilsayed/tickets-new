                                        ...
                                        <tr>
                                                    ...
                                                    @elseif($row->type == 'text')
                                                        ...
                                                        <div>
                                                            ...
                                                            @if (is_array($data->{$row->field}))
                                                                {!! implode('<br>', Arr::flatten($data->{$row->field})) !!}
                                                            @else
                                                                @if (is_object($data->{$row->field}))
                                                                    {!! implode('<br>', ((array) $data->{$row->field})) !!}
                                                                @else
                                                                    {{ $data->{$row->field} }}
                                                                @endif
                                                            @endif
                                            ...
                                            <td class="no-sort no-click bread-actions">
                                                @foreach ($actions as $action)
                                                    ...
                                                    @endif
                                                @endforeach
                                                @if (!$data->toconline_item_id)
                                                    <a href="{{ route('voyager.products.create-toconline-item-from-product', $data) }}"
                                                        style="margin-right:5px; background: green; color:#fff"
                                                        class="btn pull-right" style="margin-right:7px;">
                                                        Create Item Code
                                                    </a>
                                                @endif
                                            </td>
