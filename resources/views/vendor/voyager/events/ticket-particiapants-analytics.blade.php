                                                ...
                                                <div class="panel-body">
                                                    ...
                                                    <div class="progress">
                                                        <div class="progress-bar" role="progressbar"
                                                            aria-valuenow="{{ $data['participants'] ? round(($data['checked_in'] / $data['participants']) * 100) : 0 }}"
                                                            aria-valuemin="0" aria-valuemax="100"
                                                            style="width:{{ $data['participants'] ? round(($data['checked_in'] / $data['participants']) * 100) : 0 }}%">
                                                            <span class="sr-only">
                                                    ...
                                                    <button type="button" class="btn btn-info btn-lg"
                                                        ...
                                                        data-title="{{ $date }}" data-toggle="modal"
                            ...
                            <div id="byReport" class="tab-pane fade">
                                ...
                                <ul class="nav nav-pills">
                                    <li class="active"><a data-toggle="pill"
                                            href="#paid">{{ __('words.paid_ticket') }}</a></li>
                                    <li><a data-toggle="pill" href="#invite">{{ __('words.invite_ticket') }}</a></li>
                                    <li><a data-toggle="pill" href="#physical">{{ __('words.physical_ticket') }}</a></li>
                                </ul>
                                <div class="tab-content">
                                    ...
                                    <div id="paid" class="tab-pane fade in active">
                                        ...
                                        <br>
                                        <div class="row">
                                            @if (isset($report['by_type']['paid']))
                                                @foreach ($report['by_type']['paid'] as $data)
                                                    <div class="col-md-6">
                                                        <div class="panel panel-bordered"
                                                            style="box-shadow: 5px 5px 10px #0000005e">
                                                            <div class="panel-body">
                                                                ...
                                                                <div class="progress">
                                                                    <div class="progress-bar" role="progressbar"
                                                                        ...
                                                                        style="width:{{ $data['participants'] ? round(($data['checked_in'] / $data['participants']) * 100) : 0 }}%">
                                                                        <span
                                                                            class="sr-only">{{ $data['participants'] ? round(($data['checked_in'] / $data['participants']) * 100) : 0 }}%
                                                                            Complete</span>
                                                                    </div>
                                                                </div>
                                                                <button type="button" class="btn btn-info btn-lg"
                                                                    ...
                                                                    data-toggle="modal"
                                                                    data-target="#myModalType">View</button>
                                                            </div>
                                    ...
                                    <div id="invite" class="tab-pane fade">
                                        ...
                                        <br>
                                        <div class="row">
                                            @if (isset($report['by_type']['invite']))
                                                @foreach ($report['by_type']['invite'] as $data)
                                                    <div class="col-md-6">
                                                        <div class="panel panel-bordered"
                                                            style="box-shadow: 5px 5px 10px #0000005e">
                                                            <div class="panel-body">
                                    ...
                                    <div id="physical" class="tab-pane fade">
                                        <h3>{{ __('words.report_by_type_physical_title') }}</h3>
                                        <br>
                                        <br>
                                        <div class="row">
                                            @if (isset($report['by_type']['physical']))
                                                @foreach ($report['by_type']['physical'] as $data)
                                                    <div class="col-md-6">
                                                        <div class="panel panel-bordered"
                                                            style="box-shadow: 5px 5px 10px #0000005e">
                                                            <div class="panel-body">
        ...
        [...document.querySelectorAll("[data-target='#myModal']")].forEach(element => {
            element.addEventListener("click", function(e) {
                ...
                let html = `   <h3 class="text-center text-primary">
                    ...
                    </div><h3 class="text-center text-primary">
                       {{ __('words.physical_ticket') }}
                    </h3>
                    ...
                    <div class="row">
                        <div class="col-md-4 text-center">
                            ...
                            <h2>
                                 ${data.type.physical.participants}
                            </h2>
                        </div>
                        <div class="col-md-4 text-center">
                            <h4>
