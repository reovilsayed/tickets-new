          ...
          <div class="row">
            <div class="col-12">
              <div class="card">
                ...
                <div>
                  <a href="{{ route('voyager.events.customer.analytics.orders', ['event' => $event, 'user' => $user]) }}" class="btn btn-custom">
                    View Orders
                  </a>
                  <a href="{{ route('voyager.events.customer.analytics.tickets', ['event' => $event, 'user' => $user]) }}" class="btn btn-custom">
                    View Tickets
                  </a>
